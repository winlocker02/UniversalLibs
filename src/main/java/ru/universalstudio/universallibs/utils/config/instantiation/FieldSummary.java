package ru.universalstudio.universallibs.utils.config.instantiation;

import ru.universalstudio.universallibs.utils.config.*;
...
public class FieldSummary {
	...
	private final Map<ConfigField, TypeConverter<?>> converters;
	private final Field configPath;
	private final StringConverter<?> configPathConverter;
